...
"""
Created on Thu May  4 23:32:34 2018
@author: manjeet
"""
# Import libraries
import os,cv2
...
if USE_SKLEARN_PREPROCESSING:
	...
	print (img_data_scaled.shape)  #(808,16384=128*128)
...
print (np.shape(activations))   #(1,1,128,128,32)--tensorflow
feature_maps = activations[0][0]      
print (np.shape(feature_maps))  #(128,128,32)--tensorflow
